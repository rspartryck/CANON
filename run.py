import os
Twitter_prefix = "/data/caozhang/cache_dataset/" # to be filled
                        ...
                        if workload_type == "Zipf":
                            ...
                            for ratio in Zipf_size_ratio:
                                ...
                                for zipf_const in zipf:
                                    output_file = "Zipf/" + path_2 + str(zipf_const) + "_" + str(ratio) + "size_" + cache_type + "_rebuild" + str(freq) + ".txt"
                                    command = "numactl --cpunodebind=0 --membind=1 ./build/test_trace " + str(thread) + " " + str(cache_size) \
                            ...
                            for trace in Twitter_list:
                                ...
                                for cache_size in Twitter_list[trace][0]:
                                    output_file = "twitter/" + path_2 + trace + "_" + str(cache_size) + "_" + cache_type + "_rebuild" + str(freq) + ".txt"
